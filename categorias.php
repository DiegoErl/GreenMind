                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">Semillas</a></li>
                            <li><a class="text-decoration-none" href="#">Fertilizantes Orgánicos</a></li>
                            <li><a class="text-decoration-none" href="#">Herramientas y Equipos</a></li>
                            <li><a class="text-decoration-none" href="#">Equipos de Riego y Medición</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">Obras disponibles</a>
                            </li>
                        </ul>
                    </div>
